...
public class edit extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
				...
				Drivepojo c = (Drivepojo) ObjMap.getObjectFromJSON(s, Drivepojo.class);
				try {
					saveData1(c);
			...
			public static Map<String, String> saveData1(Drivepojo c) throws ClassNotFoundException, SQLException {
				System.out.println("in edit query method");

				Connection con = DaoLayer.getConnection();
				
				PreparedStatement ps = con.prepareStatement("update createdata set companyname=?,resources=?, exp=?,ctc=?,positions=?, joining=?,education=?, followup=?,bond=? where id=?;");
